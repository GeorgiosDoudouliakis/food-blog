...
@Injectable()
export class CountryMealsService extends AbstractMealsServiceDirective {
  public getMeals(searchTerm: string): Observable<Meal[]> {
    return this.http.get<{ meals: Meal[] }>(`https://www.themealdb.com/api/json/v1/1/filter.php?a=${searchTerm}`).pipe(
